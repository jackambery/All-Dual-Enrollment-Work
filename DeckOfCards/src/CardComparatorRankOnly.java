...
/**
 * This class compares the rank of two given cards.
 * @author Jack Ambery
 *
 */
public abstract class CardComparatorRankOnly implements Comparator<Card> {
	 ...
	 * @return integer 0, 1, or -1 if Card a's rank is equal to, greater than, or less than Card b
	 */
	@Override
	public int compare(Card a, Card b) {
		try {
			return a.compareRankTo(b);
